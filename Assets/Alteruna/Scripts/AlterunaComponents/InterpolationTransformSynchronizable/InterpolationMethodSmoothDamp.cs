...
namespace Alteruna.Multiplayer.Unity
{
	...
	{
		private class InterpolationMethodSmoothDamp : InterpolationMethodLerpRelative
		{
			...
			public InterpolationMethodSmoothDamp(Transform targetTransform) : base(targetTransform) { }
