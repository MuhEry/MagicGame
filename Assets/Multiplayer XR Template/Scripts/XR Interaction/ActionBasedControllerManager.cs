...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.StarterAssets
{
	...
	public class ActionBasedControllerManager : MonoBehaviour
	{
		...
		/// </summary>
		private static readonly List<UnityEngine.XR.Interaction.Toolkit.Interactors.IXRGroupMember> s_GroupMembers = new();
		...
		private UnityEngine.XR.Interaction.Toolkit.Interactors.XRInteractionGroup m_ManipulationInteractionGroup;

		[SerializeField] [Tooltip("The GameObject containing the interactor used for direct manipulation.")]
		private UnityEngine.XR.Interaction.Toolkit.Interactors.XRDirectInteractor m_DirectInteractor;
		...
		private UnityEngine.XR.Interaction.Toolkit.Interactors.XRRayInteractor m_TeleportInteractor;
		...
		private UnityEvent<UnityEngine.XR.Interaction.Toolkit.Interactors.IXRRayProvider> m_RayInteractorChanged;
